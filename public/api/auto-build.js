...
// We ask for application/json directly (generationConfig.responseMimeType
// above), so this is mostly a safety net in case a response ever comes back
// wrapped in a ```json ... ``` fence anyway.
